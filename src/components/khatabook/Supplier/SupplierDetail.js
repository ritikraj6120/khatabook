...
const CustomerDetail = () => {
	const { singleCustomerDetail ,editCustomer} = useContext(SupplierContext);

	const [credentials, setCredentials] = useState({ title: singleCustomerDetail.title, name: singleCustomerDetail.name, phone:singleCustomerDetail.phone })
	...
	const handleSubmit = async (e) => {
		...
		await editCustomer(singleCustomerDetail._id, title, name,phone);
	}
